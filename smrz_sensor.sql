...
--
-- Table structure for table `smrz_sensor`
--

DROP TABLE IF EXISTS `smrz_sensor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `smrz_sensor` (
  `id` int(11) NOT NULL,
  `name` tinytext CHARACTER SET latin1 NOT NULL,
  `type` tinytext COLLATE latin2_czech_cs NOT NULL,
  `coef` float NOT NULL,
  `purge` int(11) NOT NULL,
...
-- Dump completed on 2016-01-13  6:18:31
